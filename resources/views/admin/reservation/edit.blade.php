                ...
                <form action="{{ route('admin.reservation.update', $reservation->id) }}" method="POST" 
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="first_name"
                            ...
                            required  value="{{$reservation->first_name}}">
                    </div>
                    <div class="mb-2">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Your
                            last name</label>
                        <input type="text" name="last_name"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                              dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required value="{{$reservation->last_name}}">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="number"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                              dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required value="{{$reservation->tel_number}}">
                    </div>
                    <div class="mb-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 ">
                            reservation date</label>
                        <input type="datetime-local" name="res_date"  value="{{$reservation->res_data}}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="geust_num"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                             dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required value="{{$reservation->geust_number}}">
                    </div>
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900 ">
                            Table</label>
                        <div class="mt-1">
                            <select type="text" name="table_id" class=" text-gray-900 form-multiselect block w-full mt-1">
                                @foreach ($tables as $table)
                                    <option value="{{ $table->id }}" @selected($table->id ==$reservation->table_id )>{{ $table->name }} ({{$table->geust_num}} Geusts)</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
